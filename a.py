...
def main():
    ...
    with st.sidebar:
        ...
        if presentation_mode:
            st.markdown("""
            <div style="background: rgba(59, 130, 246, 0.1); padding: 15px; border-radius: 12px; margin: 10px 0; border: 2px solid #3b82f6;">
                <strong style="color: #3b82f6;">🎥 Presentation Mode Active</strong><br>
    ...
    <div class="quantum-card">
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <div>
                <h1 style="margin: 0; background: var(--gold-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
            ...
            <div style="display: flex; gap: 10px;">
                <span class="luxury-badge">AI-Powered</span>
                <span class="luxury-badge">Real-Time</span>
                <span class="luxury-badge">Predictive</span>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with tab1:
        ...
        with col1:
            st.markdown(f"""
            <div style="background: rgba(245, 158, 11, 0.1); padding: 20px; border-radius: 12px; margin: 10px 0; border-left: 4px solid #f59e0b;">
                <strong style="color: #f59e0b;">⚠️ Isolation Forest Detection</strong><br>
        ...
        with col2:
            st.markdown(f"""
            <div style="background: rgba(239, 68, 68, 0.1); padding: 20px; border-radius: 12px; margin: 10px 0; border-left: 4px solid #ef4444;">
                <strong style="color: #ef4444;">🔍 Statistical Outliers</strong><br>
                <span style="color: #cbd5e1;">
            ...
            for segment, data in segment_summary.iterrows():
                ...
                <div style="background: rgba(255,255,255,0.05); padding: 15px; border-radius: 12px; margin: 10px 0;">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <span style="background: var(--gold-gradient); color: white; padding: 4px 10px; border-radius: 20px; font-size: 0.8rem;">
